    ...
    public class ButtonHelper
    {
        ...
        public static ButtonHelper Current
        {
            get
            {
                lock (_lock)
                {
                    if (current == null) current = new ButtonHelper(Buttons.BottomLeft, Buttons.BottomRight, Buttons.MiddleRight, Buttons.TopLeft, Buttons.TopRight);
                }
                return current;
            }
        }
        ...
        {
            Debug.Print("PIN:" + data1.ToString());
